...
#     BG = "E6E6E6"
#     content_w_inches = page_width - left_margin - right_margin
#     LOGO_H_INCHES = 0.32
...
#     tblGrid = OxmlElement('w:tblGrid')
#     for dxa in [PAGE_COL_DXA, MID_COL_DXA, LOGO_COL_DXA]:
#         gc = OxmlElement('w:gridCol')
...
#     def make_header_cell(width_dxa, align='left'):
#         tc = OxmlElement('w:tc')
#         tcPr = OxmlElement('w:tcPr')
#         tcW = OxmlElement('w:tcW')
#         tcW.set(qn('w:w'), str(width_dxa))
...
#     # Cell 1: page number
#     tc1 = make_header_cell(PAGE_COL_DXA)
#     p1 = OxmlElement('w:p')
#     pPr1 = OxmlElement('w:pPr')
#     jc1 = OxmlElement('w:jc'); jc1.set(qn('w:val'), 'left'); pPr1.append(jc1)
#     sp1 = OxmlElement('w:spacing'); sp1.set(qn('w:before'), '0'); sp1.set(qn('w:after'), '0'); pPr1.append(sp1)
#     p1.append(pPr1)
#     for ftype, content in [('begin', None), ('instr', ' PAGE '), ('end', None)]:
#         r = OxmlElement('w:r')
#         rPr = OxmlElement('w:rPr')
#         b = OxmlElement('w:b'); rPr.append(b)
#         sz = OxmlElement('w:sz'); sz.set(qn('w:val'), str(int(header_font * 2))); rPr.append(sz)
#         r.append(rPr)
#         if ftype == 'instr':
...
#     # Cell 2: topic/book name
#     tc2 = make_header_cell(MID_COL_DXA)
#     p2 = OxmlElement('w:p')
#     pPr2 = OxmlElement('w:pPr')
#     jc2 = OxmlElement('w:jc'); jc2.set(qn('w:val'), 'center'); pPr2.append(jc2)
#     sp2 = OxmlElement('w:spacing'); sp2.set(qn('w:before'), '0'); sp2.set(qn('w:after'), '0'); pPr2.append(sp2)
#     p2.append(pPr2)
#     r2 = OxmlElement('w:r')
#     rPr2 = OxmlElement('w:rPr')
#     if header_bold:
#         b2 = OxmlElement('w:b'); rPr2.append(b2)
#     sz2 = OxmlElement('w:sz'); sz2.set(qn('w:val'), str(int(header_font * 2))); rPr2.append(sz2)
#     rF2 = OxmlElement('w:rFonts')
#     rF2.set(qn('w:ascii'), FONT_DOCX); rF2.set(qn('w:hAnsi'), FONT_DOCX); rF2.set(qn('w:cs'), FONT_DOCX)
#     rPr2.insert(0, rF2)
#     r2.append(rPr2)
#     t2 = OxmlElement('w:t')
#     t2.set(qn('xml:space'), 'preserve')
#     centre_text = topic_name.strip() if topic_name.strip() else (book_name + (" | " + chapter_title if chapter_title else ""))
#     t2.text = centre_text
#     r2.append(t2)
#     p2.append(r2)
#     tc2.append(p2)
...
#     # Cell 3: logo
#     tc3 = make_header_cell(LOGO_COL_DXA)
#     tr.append(tc3)
#     from docx.table import _Cell
#     cell3 = _Cell(tc3, header)
#     p3 = cell3.add_paragraph()
#     p3.alignment = WD_ALIGN_PARAGRAPH.RIGHT
#     LOGO_PATH = "logo.png"
#     if os.path.exists(LOGO_PATH):
#         run = p3.add_run()
#         run.add_picture(LOGO_PATH, width=Inches(LOGO_W_INCHES), height=Inches(LOGO_H_INCHES))
#     else:
#         p3.add_run("RBD")
